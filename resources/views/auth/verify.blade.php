                                ...
                                <div class="account-box">
                                    ...
                                    <div class="account-content">
                                        <div class="m-b-10 text-center">
                                            ...
                                            @endif
                                            <p class="text-muted font-13 m-t-10"> A email has been send to <b>{{ Auth::user()->email }}</b>.
                                                Please check for an email from company and click on the included link to
                                                verify your account. </p>

                                                <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                                                    @csrf
                                                    <button type="submit" class="btn btn-md btn-block btn-primary waves-effect waves-light m-t-30">{{ __('click here to request another') }}</button>.
                                                </form>
                                        </div>
