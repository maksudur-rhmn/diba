                  ...
                  @forelse ($appointments as $appointment)
                   <tr style="color: #222;">
                    ...
                    <td>
                        ...
                        <a href="{{ route('cancel.appointment', $appointment->id) }}" class="btn btn-danger">Cancel Appointment</a>
                        @else 
                        <a href="{{ route('reconfirm.appointment', $appointment->id) }}" class="btn btn-success">Re-Confirm Appointment</a>
                        @endif
                    </td>
                   </tr>
                  @empty
